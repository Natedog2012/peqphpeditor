          ...
          <fieldset style="text-align:left;">
            ...
            <table width="100%" border="0" cellpadding="3" cellspacing="0">
			  ...
			  <tr>
				...
				<td widgth ="16%">Cast Restriction:<br><input type="text" name="CastRestrictionText" size="3" value="<?=$CastRestriction?>"></td>
				...
				<td widgth ="16%">Caster Required:<br><input type="text" name="f220text" size="3" value="<?=$field220?>">
